...
class MqttTest:
    "test mqtt some api like publish/batchPub.."
    # api base url
    __baseUrl = "http://xxx.x.x.x/"
    __appKey = ""
    __appSecret=""
    #__fileHandle
    ...
    def patchPublishMsg(self, totalMsg, threadCount):
        with ThreadPoolExecutor(threadCount) as excutors:
            allTasks = [excutors.submit(self.publishMsg, (self.__genPatchMsg(index))) for index in range(0, totalMsg)]
